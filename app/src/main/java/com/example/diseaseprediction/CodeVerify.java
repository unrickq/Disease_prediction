...
//      code_verify_edit_txt_code_layout.getEditText().requestFocus();
//      // Display keyboard
//      InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
//      imm.showSoftInput(code_verify_edit_txt_code_layout.getEditText(), InputMethodManager.SHOW_IMPLICIT);
    ...
    mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
      ...
      public void onVerificationFailed(FirebaseException e) {
        ...
        if (e instanceof FirebaseAuthInvalidCredentialsException) {
          ...
          displayErrorDialog(getString(R.string.code_verify_exception_phone_invalid));
        } else if (e instanceof FirebaseTooManyRequestsException) {
          // The SMS quota for the project has been exceeded
          Log.e(TAG, "The SMS quota for the project has been exceeded", e);
          displayErrorDialog(getString(R.string.code_verify_exception_device_blocked));
        } else {
          // Show a message and update the UI
          displayErrorDialog(getString(R.string.code_verify_exception_verification_failed_unknown));
        }
  ...
  /**
   * Create an {@link AlertDialog} to display error message
   *
